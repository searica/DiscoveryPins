...
internal class AutoPinner : MonoBehaviour
{
    ...
    {
        AutoPinner autoPinner = target.GetOrAddComponent<AutoPinner>();
    ...
    public void CheckForAutoPinShortcut()
    {
        ...
        float dotTol = Mathf.Acos(Mathf.Deg2Rad * (GameCamera.instance.m_fov / 2f));
    ...
    private bool IsPointVisibleOrCloseEnough(Vector3 pos, Vector3 playerPosition, Vector3 lookDir, float dotTolerance)
    {
        ...
        float dirDot = Vector3.Dot(posDir, lookDir);
    ...
    public bool AddAutoPin()
    {
        ...
        PinData closestPin = FindClosestPin(Position, out float closestDis);
    ...
    {
        PinData pin = FindClosestPin(pos, out float closestDis, type);
    ...
    public static PinData FindClosestPin(Vector3 pos, out float closestDis, PinType type = PinType.None)
    {
        ...
        foreach ((PinData pin, float dis) in pins)
        {
